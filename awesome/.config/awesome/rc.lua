...
-- Restore clients with proper tags
...
-- {{{ Autorun
awful.spawn.single_instance("xss-lock -- i3lock -c 000000")
awful.spawn.single_instance("xfsettingsd")
awful.spawn.single_instance("xfce4-power-manager")
awful.spawn.single_instance("xfce4-volumed")
awful.spawn.single_instance("nm-applet")
awful.spawn.single_instance("wmname LG3D")
awful.spawn.single_instance("/home/luk/bin/redshift-gtk-wrapper")
-- }}}

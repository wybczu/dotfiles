...
dofile("/etc/xdg/awesome/debian/menu.lua")
...
f_keys = {"F1", "F2", "F3", "F4", "F5", "F6", "F7", "F8", "F9" }
for i = 1, keynumber do
    globalkeys = awful.util.table.join(globalkeys,
        awful.key({ modkey }, f_keys[i],
                  function ()
        ...
        awful.key({ modkey, "Control" }, f_keys[i],
                  function ()
                      local screen = mouse.screen
                      if tags[screen][i] then
        ...
        awful.key({ modkey, "Shift" }, f_keys[i],
                  function ()
                      if client.focus and tags[client.focus.screen][i] then
                          awful.client.movetotag(tags[client.focus.screen][i])
                      end
                  end),
        awful.key({ modkey, "Control", "Shift" }, f_keys[i],
                  function ()
                      if client.focus and tags[client.focus.screen][i] then
